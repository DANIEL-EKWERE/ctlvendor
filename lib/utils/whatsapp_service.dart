...
enum UserContext { customer, vendor, general }

class WhatsAppService {
  static const String _phoneNumber =
      '2348001234567'; // Replace with actual number

  static String _getMessageTemplate(UserContext context) {
    switch (context) {
      case UserContext.customer:
        return 'Hello NK sereke Support, I am a customer and I need help with: ';
      case UserContext.vendor:
        return 'Hello NK sereke Support, I am a vendor and I need help with: ';
      case UserContext.general:
      default:
        return 'Hello NK sereke Support, I need help with: ';
    }
  }
      ...
      if (context.mounted) {
        showDialog(
          ...
          builder: (context) => AlertDialog(
            ...
            content: const Text(
              'WhatsApp is not installed on your device or could not be opened.',
            ),
            actions: [
              TextButton(
